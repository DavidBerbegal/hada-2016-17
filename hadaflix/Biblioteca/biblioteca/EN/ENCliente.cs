...
namespace Biblioteca
{
    public class ENCliente
    {
        ...
        public void InsertarCliente()
        {
            ...
            cadCliente.InsertarCliente(this);
        }

        // READ CLIENT
        // -------------
        // BUSCAR/LEER/ALMACENAR LISTA DE CLIENTES
        ...
        public void ActualizarCliente()
        {
            CADCliente cadCliente;
            cadCliente = new CADCliente();
            cadCliente.ActualizarCliente(this);
        }
        ...
        public void EliminarCliente()
        {
            CADCliente cadCliente;
            cadCliente = new CADCliente();
            cadCliente.EliminarCliente(this);
        }
        #endregion

        public ENCliente getUserByNick()
        {
