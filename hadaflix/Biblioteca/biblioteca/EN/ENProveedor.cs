...
namespace Biblioteca
{
    public class ENProveedor
    {
        ...
        {
            CADProveedor cadProveedor;
            cadProveedor = new CADProveedor();
            cadProveedor.ActualizarProveedor(this);
        }
        ...
        public List<ENProveedor> BuscarProveedor()
        {
             ...
             proveedores = pr.BuscarProveedor();
