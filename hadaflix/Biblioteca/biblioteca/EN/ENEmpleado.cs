...
namespace Biblioteca
{
    public class ENEmpleado
    {
        ...
        // CREATE EMPLEADO
        // ---------------
        // CREAR/INSERTAR EMPLEADO
        public void InsertarEmpleado()
        {
            CADEmpleado cadEmpleado;
            cadEmpleado = new CADEmpleado();
            cadEmpleado.InsertarEmpleado(this);
        }

        // READ EMPLEADO
        // -------------
        // BUSCAR/LEER/ALMACENAR LISTA DE EMPLEADOS
        public List<ENEmpleado> BuscarEmpleado()
        {
            List<ENEmpleado> empleados = new List<ENEmpleado>();
            CADEmpleado c = new CADEmpleado();
            empleados = c.BuscarEmpleado();
        ...
        public void ActualizarEmpleado()
        {
            CADEmpleado cadEmpleado;
            cadEmpleado = new CADEmpleado();
            cadEmpleado.ActualizarEmpleado(this);
        }
        ...
        public void EliminarEmpleado()
        {
            CADEmpleado cadEmpleado;
            cadEmpleado = new CADEmpleado();
            cadEmpleado.EliminarEmpleado(this);
        }
        #endregion
    }
}